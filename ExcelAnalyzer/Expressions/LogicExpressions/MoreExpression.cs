...
namespace ExcelAnalyzer.Expressions.LogicExpressions
{
    ...
    class MoreExpression : CompoundExpression
    {
        ...
        {
            return this.LeftExpression.Formula() + @" " + LogicExpression.SymbolMore + @" " + this.RightExpression.Formula();
        }
        ...
        public override string ToString(string format)
        {
            ...
            {
                return GetLeftFormula(format: format) + @" " + LogicExpression.SymbolMore + @" " + GetRightFormula(format: format);
            }
            else
            {
                return GetLeftFormula() + @" " + LogicExpression.SymbolMore + @" " + GetRightFormula();
            }
        }

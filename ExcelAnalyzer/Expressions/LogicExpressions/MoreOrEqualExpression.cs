...
namespace ExcelAnalyzer.Expressions.LogicExpressions
{
    ...
    class MoreOrEqualExpression : CompoundExpression
    {
        ...
        {
            return this.LeftExpression.Formula() + @" " + LogicExpression.SymbolMoreOrEqual + @" " + this.RightExpression.Formula();
        }
        ...
        public override string ToString(string format)
        {
            ...
            {
                return GetLeftFormula(format: format) + @" " + LogicExpression.SymbolMoreOrEqual + @" " + GetRightFormula(format: format);
            }
            else
            {
                return GetLeftFormula() + @" " + LogicExpression.SymbolMoreOrEqual + @" " + GetRightFormula();
            }
        }
